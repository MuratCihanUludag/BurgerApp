...
var connectionString = builder.Configuration.GetConnectionString("BurgerAppContextConnectionCan") ?? throw new InvalidOperationException("Connection string 'BurgerAppContextConnection' not found.");
